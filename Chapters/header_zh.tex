...
\setCJKmainfont[Path=Fonts/]{inziu-iosevka-SC-regular}
\setCJKsansfont[Path=Fonts/]{inziu-iosevka-SC-regular}
...
\setmonofont[Mapping={},Path=Fonts/]{SourceCodePro-Light}
